...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { description: @point.description, lat: @point.lat, lng: @point.lng, title: @point.title }
    end
  ...
  test "should update point" do
    patch :update, id: @point, point: { description: @point.description, lat: @point.lat, lng: @point.lng, title: @point.title }
    assert_redirected_to point_path(assigns(:point))
  end
